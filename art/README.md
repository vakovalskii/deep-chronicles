...
- Звуковой первый проход: 13 оригинальных синтезированных PCM WAV в `godot/assets/audio/`. Авторский генератор `tools/godot/audio.mjs`, фиксированный seed, без сторонних семплов или сетевых сервисов. `npm run native:audio -- --check` проверяет воспроизводимость. Это звуки действий и фон; музыка и голоса пока не записаны.
