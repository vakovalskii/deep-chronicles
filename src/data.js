...
export const CLASSES = {
  warrior: {
    ...
    base: { hp: 120, mp: 30, patk: 9, matk: 3, pdef: 40, mdef: 30, aspd: 1.0, speed: 18, crit: 0.08 },
  ...
  mage: {
    ...
    base: { hp: 80, mp: 90, patk: 4, matk: 12, pdef: 30, mdef: 45, aspd: 0.8, speed: 16.8, crit: 0.05 },
